...
c System: nh3
c Name: 
c Int Coords: Cartesian
c Special Features:

c Original code written by:
c       B. Maessen, P. Bopp, D. R. McLaughlin, and M. Wolfsberg
...
c****************************************************         
      REF(1)= 'NH3 Potential Energy Surface'
      REF(2)= 'Reference:'
      REF(3)= '	B. Maessen, P. Bopp, D. R. McLaughlin, and M. Wolfsberg'
      REF(4)= '	Z. Naturforsch. Teil A 39, 1005-1006 (1984).'
      REF(5)= ''
      IRCTNT = 3
      INDEXES(1) = 7
      INDEXES(2) = 1
...
c End of original code        
     ...
     X                NATOMS,ICARTR,MDER,MSURF,REF
      COMMON /POTCON/ RE, ALPHAE, A, B, C, SDR, SDR2, SDA, SDA2, 
     *                SRIJ, SAIJ, PRDR, PRDA, DAIJ(3), DRIJ(3), C2A, C2B, C2C, 
     *                C2D, C2E, C2F, C3A, C3B, C3C, C3D, C3E, C3F, C3G, C3H, 
     *                C4A            
c****************************************************         
c all other labeled commons for PREPOT or POT                 
c****************************************************         
      DATA NDER,ANUZERO,NFLAG,NULBL/0,0.0,1,1,15*0,6,0,0,25*0/
      DATA NATOMS,ICARTR,MDER,MSURF/4,1,1,0/
      DATA NASURF/1,35*0/
c****************************************************         
c all other data statements                                   
c****************************************************
      DATA RE, A, B, C, C2A, C2B, C2C, 
     *                C2D, C2E, C2F, C3A, C3B, C3C, C3D, C3E, C3F, C3G,
     *                C3H, C4A/
     *     1.024D0,0.53190D-11,1.1406D-11,0.6140D0,3.52595D0,0.22163D0,
     *     -0.22163D0, 0.01480D0,-0.11620D0,0.05810D0,-0.55000D0,
     *     -0.54000D0,-7.01000D0,-0.03778D0,0.05667D0,-0.22667D0,
     *     -0.07000D0,0.07000D0,11.07417D0/
      END
      
      
c****************************************************
c Other subroutines from the original library
c****************************************************
