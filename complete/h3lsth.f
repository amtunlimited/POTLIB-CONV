...
c       B. Liu, J. Chem. Phys., Vol. 58, 1925(1973);
...
c**************************************************** 
      R1 = 1.40105D0
      IC = 0
    5 CALL SPL1D2(87,RKW,EKW,WKW,1,R1,S1)
...
C WB DERIVATIVES
C
   30 WB1P=(R(1)/R(3)-1.D0)/R(2)-1.D0/R(3)-(COS2+COS3)/R(1)
...
C
      ...
      EB4APR=RI*(WB2*F2*(-2.D0)*R1*D2*EXF2-F1*D1*WB*EXF1)
      EB4AP1=EB4APW*WB1P-EB4A/X21+EB4APR
      EB4AP2=EB4APW*WB2P-EB4A/X22+EB4APR
      EB4AP3=EB4APW*WB3P-EB4A/X23+EB4APR
      EB4BPW=EB4B*EQ
      B4BPEQ=EB4B*WB
      EB4BPR=EQ*WB*((-2.D0)*F2*R1*D4*EXF2-F1*D3*EXF1)
      EB4BP1=EB4BPW*WB1P+B4BPEQ*(6.D0*R(1)-2.D0*R1)+EB4BPR
      EB4BP2=EB4BPW*WB2P+B4BPEQ*(6.D0*R(2)-2.D0*R1)+EB4BPR
      EB4BP3=EB4BPW*WB3P+B4BPEQ*(6.D0*R(3)-2.D0*R1)+EB4BPR
C
