...
c Name: fh25secgm4              
c Int Coords: R
c Special Features: One order derivative
c
...
c***********************************************************************
      ...
      COMMON /USRICM/ CART(25,3),ANUZERO,NULBL(25),     
     X                NFLAG(20),NASURF(6,6),NDER  
...
c      COMMON /POTDCM/ VDUM(10)
      COMMON /DECOM/ DISSE(3)
C
c      COMMON /DIST/RM(3),R0(3)                                          
c      COMMON /REF/RO(3)        
      COMMON /TPAR/XHH(3),XHF(3),P(4)      
c      COMMON /ATAT/CHH(10),CHF(10)                 
c      COMMON /COEFF/CFHH,CHHF  
c      COMMON /TRIAL/ETA1(10),ETA2(10),ETA3(10),
c     1              ETAP1(10),ETAP2(10),ETAP3(10)  
c      COMMON /KKP/CK1(10),CK2(10),CK3(10),CKP1(10),CKP2(10),CKP3(10)      
c      COMMON /DIAT/D(3),A1(3),A2(3),A3(3),GAMMA(3)
c      COMMON /SWPAR/ DEC(3),RB(3),SW(3),DSW(3,3)
c      COMMON /CSI/FCSI,FCSI1,FCSI2
      COMMON /LOCAL/C3C,ALF,ALFP,ALFT,P3C,Q3C,BETP
      COMMON /DISPC/ALPH0,ALPH1,BET0,BET1                           
C
      COMMON /DAMPC/AD1,AD2,AD3,BD1,BD2,BD3
c      COMMON /DPC/DP1(3),DP2(3),DP3(3),DDP1(3),DDP2(3),DDP3(3)
c      COMMON /DEDRCM/DCORR2(3),DCORR3(3),DLDR(3),DE3C(3)
c      COMMON /ENGYCM/ECOR2B, ECOR3B, ELOND, E3C
c      COMMON /PAR/BHH(5),BHF(5)
c      COMMON /VTANH/RTANH(3,10),DRTANH(3,10)
...
1400  FORMAT(/,2X,T5,'Parameters for the 3-body term:',
     ...
     X                DIJCART(NATOM,3,JSURF)                  
      COMMON /PT1CM/ R(75),ENGYGS,DEGSDR(75)          
...
C
       ENGYGS = ECOR2B + ECOR3B + ELOND + E3C + DISSE(2)
c       WRITE (6,*) "Checkpoint Alpha"
c       WRITE (6,*) ECOR2B
c       WRITE (6,*) ECOR3B
c       WRITE (6,*) ELOND
c       WRITE (6,*) E3C
