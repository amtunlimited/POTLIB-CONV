...
c
      ...
      parameter (wvnsep=400.d0)

      dimension de(3),re(3),b(3),s(3),pf(3),spl(3),r(3),e(3)
...
10    continue
      ...
      write(6,*) 'Potential code called for ClH2 surface TA1.'
...
c
      ...
      e2new=rt1-(1.d0-sinchi4)*zl*(rt1-rt2)*(z*dexp(1.d0-z))
     &      *dexp(-((r(1)-spl(1)+r(3)-spl(3))**4/r10**4
     &      +(r(2)-spl(2))**4/r20**4))
